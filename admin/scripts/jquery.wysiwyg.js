...
(function( $ )
{
	...
	$.extend(Wysiwyg, {
		...
		TOOLBAR : {
			...
			h1mozilla : { visible : true && $.browser && $.browser.mozilla, className : 'h1', command : 'heading', arguments : ['h1'], tags : ['h1'] },
			h2mozilla : { visible : true && $.browser && $.browser.mozilla, className : 'h2', command : 'heading', arguments : ['h2'], tags : ['h2'] },
			h3mozilla : { visible : true && $.browser && $.browser.mozilla, className : 'h3', command : 'heading', arguments : ['h3'], tags : ['h3'] },

			h1 : { visible : true && !( $.browser && $.browser.mozilla ), className : 'h1', command : 'formatBlock', arguments : ['Heading 1'], tags : ['h1'] },
			h2 : { visible : true && !( $.browser && $.browser.mozilla ), className : 'h2', command : 'formatBlock', arguments : ['Heading 2'], tags : ['h2'] },
			h3 : { visible : true && !( $.browser && $.browser.mozilla ), className : 'h3', command : 'formatBlock', arguments : ['Heading 3'], tags : ['h3'] },
